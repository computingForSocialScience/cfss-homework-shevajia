...
def writeArtistsTable(artist_info_list):
    ...
    for artist_info in artist_info_list:
        line = artist_info['id']+ u',"' + artist_info['name'] + u'",' + artist_info['followers'] + u',' + artist_info['popularity'] + u'\n'
        outfile.write(line) 
    outfile.close()   
...
def writeAlbumsTable(album_info_list):
    ...
    for album_info in album_info_list:
        line = album_info['artist_id']+ u',' + album_info['album_id'] + u',"' + album_info['name'] + u'",' + album_info['year'] + u',' + album_info['popularity'] + u'\n'
        outfile.write(line) 
    outfile.close() 
